        ...
        >
          ...
          <div>
            ...
            <div className="space-y-6">
               <div className="p-6 bg-card rounded-xl border border-border hover:border-primary/30 transition-colors group">
                 ...
                 <a href="mailto:ABDALRHMANMANASHNY@GMAIL.COM" className="text-foreground pl-14 hover:text-primary transition-colors">
               ...
               <div className="p-6 bg-card rounded-xl border border-border hover:border-primary/30 transition-colors group">
                 ...
                 <p className="text-foreground pl-14">+966 53 211 2101</p>
               </div>
